...
(function($){
	...
	$.fn.contactable = function(options) {
		//set default options  
		var defaults = {
			url: 'http://www.transwarp.se/public/mail.php',
			name: 'Namn',
			email: 'Email',
			message : 'Meddelande',
			subject : 'Meddelande från transwarp.se',
			submit : 'SKICKA',
			recievedMsg : 'Tack för ditt meddelande',
			notRecievedMsg : 'Ditt meddelande kunde tyvärr inte skickas, försök igen senare',
			disclaimer: 'Kontakta gärna oss.',
			hideOnSubmit: false
